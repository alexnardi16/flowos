...
function isSameDay(item: Commitment, date: Date) {
  const value = itemDate(item);
  if (!value) return false;
  const d = new Date(value);
  if (item.allDay) return d.getUTCFullYear() === date.getFullYear() && d.getUTCMonth() === date.getMonth() && d.getUTCDate() === date.getDate();
