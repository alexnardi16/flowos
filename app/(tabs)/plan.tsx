...
export default function Plan(){
  ...
  useEffect(()=>{
    let cancelled=false;
    void generateAIPlanningSuggestions(commitments,new Date()).then((result)=>{
      if(cancelled)return;
      setAiSuggestions(result.suggestions);
      setAiSource(result.generatedBy);
    });
